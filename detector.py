...
def predict_url(url: str) -> dict:
    ...
    checks = [
        ...
        (r"<script", 35, "XSS script tag detected"),
        (r"onerror\s*=", 25, "XSS event handler detected"),
        (r"onload\s*=", 25, "XSS event handler detected"),
        ...
        (r"information_schema", 30, "Database metadata access pattern"),
        (r"xp_cmdshell", 40, "High-risk SQL Server command execution"),
        (r"%3cscript", 35, "Encoded XSS script pattern"),
    ]
